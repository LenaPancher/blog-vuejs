...
.tesla_admin input[type="text"],
.tesla_admin input[type="email"],
.tesla_admin input[type="password"],
.tesla_admin input[type="tel"] {
  float: left;
  position: relative;
  border: none;
...
.tesla_admin input::-webkit-input-placeholder,
.tesla_admin textarea::-webkit-input-placeholder {
  color: #888da0;
  font-weight: 600;
  font-size: 12px;
  position: relative;
}
.tesla_admin input:-moz-placeholder,
.tesla_admin textarea:-moz-placeholder {
  color: #888da0;
  font-weight: 600;
  font-size: 13px;
}
